...
class RegisterTransform extends Transform {
    ...
    void transform(Context context, Collection<TransformInput> inputs
        ...
        project.logger.warn("start docking-register transform...")
        config.reset()
    ...
    void scanJar(JarInput jarInput, TransformOutputProvider outputProvider, CodeScanProcessor scanProcessor) {
        ...
        println "docking-register cost time: " + (System.currentTimeMillis() - time) + " ms to scan jar file:" + dest.absolutePath
